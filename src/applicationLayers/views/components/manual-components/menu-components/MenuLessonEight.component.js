...
export class MenuLessonEight extends Component {
  constructor() {
    super('li', {class: 'site__manual-column-left-li'}, []);
    this.textSpan = 'Восьмое занятие';
    this.node = {
      parent: this.el,
      children: [
        {tag: 'p', props: {class: 'site__manual-column-left-li-string hover', id: 'menuEightLesson'}, children: [
    ...
    this.nodeActive = {
      ...
      children: [
        ...
        {tag: 'ul', props: {class: 'site__manual-column-left-li-list'}, children: [
          ...
          {tag: 'li', props: {class: 'site__manual-column-left-li-list-item'}, children: ['Ожидаемый результат 7-8 занятия']},
        ]},
      ],
    };
  }
